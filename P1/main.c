...
char *inputfile,*outputfile,*synchstrategy;
int numthreads;
...
int main(int argc, char* argv[]) {
    ...
    synchstrategy = (char*)malloc(sizeof(char)*(strlen(argv[4])+1));
    ...
    if(strcmp(argv[4],"mutex")==0 && numthreads > 1){
    ...
    if(strcmp(argv[4], "rwlock")==0 && numthreads > 1){
